...
public class BossEnemy1 : MonoBehaviour
{
    ...
    void SpawnBit()
    {
        Vector3 spawnPositon = new Vector3(Random.Range(-2.9f, 6.0f), 0.03f, 0);

        Instantiate(Bit, spawnPositon, transform.rotation);
    }
